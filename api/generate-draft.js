...
const DEMO_MEMBERS = {
  ...
  mbr_t06: { name: 'Sandra Chen', email: 'sandra.chen@example.com', phone: '(480) 555-0567', archetype: 'Social Butterfly', healthScore: 61, tier: 'Social', joinDate: '2021-09-10', duesAnnual: 12000, riskSignals: ['Email engagement declining'], recentActivity: ['Terrace lunch with family', 'Yoga class'], preferences: 'Wine enthusiast, booth 6, brings spouse Avery to events' },
