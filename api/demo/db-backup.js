...
const BACKUP_TABLES = [
  ...
  { table: 'pos_checks', where: `member_id IN (SELECT member_id FROM members WHERE club_id = '${CLUB_ID}')` },
  { table: 'pos_line_items', where: `check_id IN (SELECT check_id FROM pos_checks WHERE member_id IN (SELECT member_id FROM members WHERE club_id = '${CLUB_ID}'))` },
  { table: 'pos_payments', where: `check_id IN (SELECT check_id FROM pos_checks WHERE member_id IN (SELECT member_id FROM members WHERE club_id = '${CLUB_ID}'))` },
