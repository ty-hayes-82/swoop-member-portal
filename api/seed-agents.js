...
export default async function handler(req, res) {
  try {
    ...
    await sql`INSERT INTO agent_actions (action_id, agent_id, action_type, priority, source, description, impact_metric, member_id, status, timestamp)
      VALUES
        ('agx_001', 'member-pulse', 'outreach', 'high', 'Member Pulse + POS', 'James Whitfield: 60% drop in dining spend over 8 weeks. Last visit lacked server greeting.', '$4,200 annual spend at risk', 'mbr_203', 'pending', NOW() - INTERVAL '2 hours'),
        ...
        ('agx_003', 'service-recovery', 'alert', 'high', 'Feedback System + POS', 'Anne Jordan filed noise complaint about patio event on 6/1. No staff follow-up recorded in 6 days.', 'Retention risk: 12-yr member, $8k/yr spend', 'mbr_089', 'pending', NOW() - INTERVAL '3 hours'),
        ...
        ('agx_005', 'member-pulse', 'outreach', 'medium', 'Member Pulse + Event RSVP', 'Robert Callahan skipped last 3 monthly mixers after attending 11 consecutively. Sentiment dip detected.', 'Engagement score dropped 22pts', 'mbr_271', 'pending', NOW() - INTERVAL '4 hours'),
