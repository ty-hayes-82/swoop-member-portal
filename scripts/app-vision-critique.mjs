...
import {
  makeTimestamp, ensureDir, writeFileSafe, extractScore, compositeScore,
  sleep, geminiWithRetry, parseCSV,
...
// ─── (Utilities, CSV parser, API helpers, and browser helpers are imported from ./lib/infra.mjs) ───
