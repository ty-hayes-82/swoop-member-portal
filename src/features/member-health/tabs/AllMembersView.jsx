...
function MemberRow({ member, isExpanded, onToggle, index, rosterOnly = false }) {
  ...
  // Health score is a cross-domain metric: require tee-sheet + at least one spending/engagement signal.
  // Showing default scores before tee-sheet data exists misleads operators with uncomputed 50s.
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="bg-swoop-row rounded-xl border border-swoop-border overflow-hidden">
        ...
        <div className="px-3 sm:px-4 py-2 border-b border-swoop-border flex items-center gap-2 flex-wrap text-[10px] text-swoop-text-muted">
          ...
          <span className="text-swoop-text-label">: Golf rounds, F&amp;B spend, and email cross-referenced to compute each health score</span>
        </div>
