    ...
    >
      ...
      <div className="text-center mb-6">
        <div className="text-7xl md:text-9xl font-black text-white leading-none tracking-tight">
          $71<span className="text-4xl md:text-5xl text-swoop-text-label font-bold">/month</span>
        </div>
        <p className="text-swoop-text-muted text-lg mt-3">per club, fully loaded</p>
      </div>

      {/* What you get */}
      <div className="max-w-2xl text-center mb-10">
        <p className="text-swoop-text-ghost text-lg md:text-xl leading-relaxed">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-10 mb-12 text-center">
        <div>
          ...
          <div className="text-sm text-swoop-text-muted mt-1">dues protected</div>
        </div>
        <div>
          <div className="text-3xl md:text-4xl font-bold text-blue-400">$8K</div>
          <div className="text-sm text-swoop-text-muted mt-1">incremental F&B</div>
        </div>
        <div>
          <div className="text-3xl md:text-4xl font-bold text-amber-400">14 hrs</div>
          <div className="text-sm text-swoop-text-muted mt-1">GM time saved / month</div>
        </div>
      </div>

      {/* ROI counter */}
      <div className="text-center">
        <div className="text-sm font-bold uppercase tracking-widest text-swoop-text-muted mb-2">Return on Investment</div>
      ...
      {/* Subtle footer */}
      <div className="absolute bottom-6 text-xs text-swoop-text-muted text-center">
