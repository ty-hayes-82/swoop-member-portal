      ...
      flows: [
        ...
        },
        {
          ...
          steps: [
            ...
            { tag: 'EXPERIENCE INSIGHTS', tagColor: theme.colors.info500, icon: '🔎', title: 'Behavioral Pattern', subtitle: 'Post-Round Timing', desc: 'Data shows these members finish rounds at peak lunch hours but bypass the clubhouse. The bridge from course to kitchen doesn\'t exist yet.', gap: '#8', navOverride: { route: 'members', intent: { mode: 'insights' } } },
