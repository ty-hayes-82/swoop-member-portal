    ...
    return (
      <PageTransition>
        <DataEmptyState
          ...
          description="Swoop cross-references your roster with tee sheet and POS data to identify at-risk members before they resign. Catch 82→61 health score drops early: clubs using Swoop protect an average of $32K+ in total annual dues revenue per at-risk member retained."
          dataType="members"
          actions={
