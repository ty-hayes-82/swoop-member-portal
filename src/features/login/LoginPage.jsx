    ...
    <div className="min-h-screen flex font-sans">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-gray-50 px-6 py-12">
        <div className="w-full max-w-[420px]">
          {/* Mobile-only logo (hidden on desktop since brand panel shows it) */}
          ...
          <button
            ...
            className="w-full py-3 rounded-xl border border-gray-200 bg-white text-gray-700 text-sm font-semibold cursor-pointer hover:bg-gray-50 transition-colors flex items-center justify-center gap-3"
          >
          ...
          <button
            ...
            className="w-full py-3 rounded-xl border border-gray-200 bg-white text-gray-700 text-sm font-semibold cursor-pointer mt-2 hover:bg-gray-50 transition-colors"
          >
            Set Up New Club
          </button>
