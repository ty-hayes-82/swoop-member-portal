...
const TEMPLATES = [
  ...
  { file: 'swoop-template-full.xlsx', label: 'Full Dataset', desc: '40 members, 120 rounds, 200 transactions, 15 complaints — everything', sheets: '4 sheets', color: '#E8740C' },
];
        ...
        <div style={{ display: 'flex', gap: '4px', marginBottom: '28px' }}>
          {STEP_LABELS.map((_, i) => (
            <div key={i} style={{
              ...
              background: i <= step ? '#F3922D' : '#E5E7EB',
