    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: theme.spacing.lg }}>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: theme.spacing.md }}>
        {[
          ...
          { label: 'Rain Impact — F&B', value: '+15%', sub: 'Revenue opportunity', accent: theme.colors.accent },
          ...
          <tbody>
            {rows.map((r, i) => (
              <tr key={i} style={{ borderTop: `1px solid ${theme.colors.border}` }}>
                ...
                <td style={{ padding: `${theme.spacing.sm} ${theme.spacing.md}`,
                  color: r.golf.startsWith('−') ? theme.colors.urgent : theme.colors.accent,
                  fontFamily: theme.fonts.mono }}>{r.golf}</td>
                <td style={{ padding: `${theme.spacing.sm} ${theme.spacing.md}`,
                  color: r.fb.startsWith('+') ? theme.colors.accent : theme.colors.textSecondary,
