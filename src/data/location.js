...
export const locationMembers = [
  ...
  { memberId: 'mbr_t01', name: 'James Whitfield', lat: 34.0398, lng: -84.5972, zone: 'Main Dining', zoneId: 'main-dining', status: 'at-risk', healthScore: 42, timeInZone: '1h 10m', needsAttention: true, recommendedAction: 'Unresolved complaint Jan 18 — service speed. GM should greet personally.' },
