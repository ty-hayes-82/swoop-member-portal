...
export const locationMembers = [
  ...
  { memberId: 'mbr_312', name: 'Robert Mills', lat: 34.0407, lng: -84.5982, zone: 'Driving Range', zoneId: 'driving-range', status: 'at-risk', healthScore: 51, timeInZone: '45m', needsAttention: true, recommendedAction: 'First visit in 3 weeks. Pro shop staff should engage and offer complimentary lesson.' },
  { memberId: 'mbr_t04', name: 'Anne Jordan', lat: 34.0430, lng: -84.5990, zone: 'Course - Hole 7', zoneId: 'course', status: 'at-risk', healthScore: 28, timeInZone: '1h 45m', needsAttention: true, recommendedAction: 'Declining — golf visits dropped Oct 4 to Nov 2 to Dec 1.' },
  ...
  { memberId: 'mbr_309', name: 'Jennifer Walsh', lat: 34.0442, lng: -84.5978, zone: 'Course - Hole 2', zoneId: 'course', status: 'watch', healthScore: 60, timeInZone: '35m', needsAttention: false, recommendedAction: 'New member — no events attended in first 60 days. Welcome event invitation recommended.' },
  ...
  { memberId: 'mbr_t07', name: 'Linda Leonard', lat: 34.0422, lng: -84.5948, zone: 'Course - Hole 10', zoneId: 'course', status: 'at-risk', healthScore: 12, timeInZone: '2h 15m', needsAttention: true, recommendedAction: 'Ghost member — last visit October. Personal outreach recommended.' },
  ...
  { memberId: 'mbr_t05', name: 'Robert Callahan', lat: 34.0398, lng: -84.5972, zone: 'Main Dining', zoneId: 'main-dining', status: 'at-risk', healthScore: 22, timeInZone: '1h 10m', needsAttention: true, recommendedAction: 'Hitting exact $3,020 F&B minimum — dining to fulfill obligation only. GM should greet personally and gauge satisfaction.' },
  ...
  { memberId: 'mbr_303', name: 'Evelyn Park', lat: 34.0391, lng: -84.5980, zone: 'Fitness Center', zoneId: 'pool', status: 'at-risk', healthScore: 64, timeInZone: '1h 30m', needsAttention: true, recommendedAction: 'Social Butterfly showing declining engagement — invite to upcoming event.' },
...
export const alertsFeed = [
  { id: 'a1', timestamp: '7:42 AM', severity: 'high', title: 'James Whitfield on Hole 14', detail: 'At-risk member (score 42). Has not dined in 6 weeks. When he finishes, have F&B manager greet at Grill Room with his usual order.', memberId: 'mbr_t01' },
  ...
  { id: 'a3', timestamp: '7:25 AM', severity: 'medium', title: 'Robert Mills at Driving Range', detail: 'First visit in 3 weeks. Positive re-engagement signal. Pro shop should offer complimentary lesson.', memberId: 'mbr_312' },
