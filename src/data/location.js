...
export const locationMembers = [
  ...
  { memberId: 'mbr_203', name: 'James Whitfield', lat: 34.0420, lng: -84.5998, zone: 'Course - Hole 14', zoneId: 'course', status: 'at-risk', healthScore: 42, timeInZone: '2h 10m', needsAttention: true, recommendedAction: 'F&B manager should greet him at Grill Room when he finishes. His usual order: club sandwich + Arnold Palmer. Has not dined in 6 weeks.' },
  ...
  { memberId: 'mbr_089', name: 'Anne Jordan', lat: 34.0430, lng: -84.5990, zone: 'Course - Hole 7', zoneId: 'course', status: 'at-risk', healthScore: 28, timeInZone: '1h 45m', needsAttention: true, recommendedAction: 'Declining — golf visits dropped Oct 4 to Nov 2 to Dec 1.' },
  ...
  { memberId: 'mbr_203', name: 'James Whitfield', lat: 34.0398, lng: -84.5972, zone: 'Main Dining', zoneId: 'main-dining', status: 'at-risk', healthScore: 42, timeInZone: '1h 10m', needsAttention: true, recommendedAction: 'Unresolved complaint Jan 18 — service speed. GM should greet personally.' },
...
export const alertsFeed = [
  { id: 'a1', timestamp: '7:42 AM', severity: 'high', title: 'James Whitfield on Hole 14', detail: 'At-risk member (score 42). Has not dined in 6 weeks. When he finishes, have F&B manager greet at Grill Room with his usual order.', memberId: 'mbr_203' },
