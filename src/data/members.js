...
export const healthDistribution = [
  { level: 'Healthy',  min: 70,  count: 138, percentage: 0.46, color: '#22C55E' },
  { level: 'Watch',    min: 50,  count: 82,  percentage: 0.27, color: '#F59E0B' },
  { level: 'At Risk',  min: 30,  count: 52,  percentage: 0.17, color: '#F97316' },
  { level: 'Critical', min: 0,   count: 28,  percentage: 0.09, color: '#EF4444' },
];
