...
export const agentActions = [
  ...
  // #67 Push notification to staff — VIP arrival
  {
    ...
    description: 'Push alert to Pro Shop + Starter: Robert Callaway ($22K VIP) arriving in 15 min. Cart #7 prepped, range balls loaded, preferred South course.',
    status: 'pending',
    impactMetric: 'VIP experience — $22K annual member',
    priority: 'high',
    memberId: 'mbr_022',
    memberName: 'Robert Callaway',
