...
export const agentActions = [
  ...
  // Closed-loop follow-up cards — show outcomes of previously approved actions
  {
    ...
    description: '30-day check-in: James Whitfield, health score recovered 42 to 58 after GM personal call. Re-engaged with 3 rounds and 2 dining visits.',
    status: 'pending',
  ...
  },
  {
    ...
    actionType: 'FOLLOW_UP',
    description: '14-day check-in: Robert Callahan, complaint resolved, health score improved 47 to 63. Dined twice since resolution. Monitoring.',
    status: 'pending',
  ...
  },
  {
    ...
    actionType: 'FOLLOW_UP',
    description: '60-day check-in: Anne Jordan. No re-engagement after win-back campaign. Health score 28 to 22. Recommend escalation to GM personal call.',
    status: 'pending',
  ...
  },
  {
    ...
    description: 'POST-MORTEM: Kevin resigned Jan 8 after 30 days of zero activity. This was preventable: his last 3 tee times were rained out with no proactive rebooking, and his buddy group (Tom Allen, Mike Franco) stopped inviting him.',
    talkingPoints: [
    ...
    dollarStake: '$18K lost. Would have cost $0 to rebook after rainout #1.',
  ...
  },
  {
    ...
    description: 'POST-MORTEM: Linda resigned Jan 15 after 30 days of zero activity. The signal was her bridge partner Diane — Diane dropped to Social-only in November, and Linda had no remaining social anchor at the club.',
    talkingPoints: [
