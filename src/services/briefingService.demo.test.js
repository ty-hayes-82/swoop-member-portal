...
// fallback at 3 entries, with Robert Callahan (mbr_t05) as the canonical third per cockpit.js + agents.js.
...
describe('DEMO_BRIEFING.todayRisks.atRiskTeetimes', () => {
  ...
  it('includes Robert Callahan (mbr_t05) as the third entry', () => {
    const third = DEMO_BRIEFING.todayRisks.atRiskTeetimes[2];
    expect(third.memberId).toBe('mbr_t05');
